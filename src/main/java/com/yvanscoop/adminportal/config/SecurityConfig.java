package com.yvanscoop.adminportal.config;

import com.yvanscoop.adminportal.services.security.UserSecurityService;
import com.yvanscoop.adminportal.utility.SecurityUtility;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .failureUrl("/login?error").defaultSuccessUrl("/book/bookList").loginPage("/login").permitAll()
